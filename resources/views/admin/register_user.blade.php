						...
						<div class="card">
							...
							@if (session('alert'))
								...
								<div class="m-sm-4">
                                    ...
                                    <form class="md-float-material form-material" method="post" action="{{route('register_user_post')}}">
                                      @csrf 
                                      <div class="mb-3">
                                       ...
                                       <div class="mb-3">
										...
										<div class="mb-3">
                                          ...
                                          <div class="mb-3">
											...
											<input class="form-control form-control-lg" type="date" name="dob" placeholder="Enter date" />
											<small>
                                          </small>
										</div>
										<div class="mb-3">
											<label class="form-label">Phone</label>
											<input class="form-control form-control-lg" type="number"min-lenth ="11" max-length ="11" name="phone" placeholder="Enter your phone" />
											<small>
                                          </small>
										</div>
										...
										<div>
											...
											<span class="form-check-label">
											<a href="{{route('admin_login')}}">Sign In</a>
											</span>
                                        </label>
										</div>
										<div class="text-center mt-3">
                                        <button type="submit" class="btn btn-md btn-block waves-effect waves-light text-center text-light m-b-20" style="background: black;">Sign Up</button>
